...
const TopBar = ({ isExpandable = true }) => {
    ...
    return (
        <nav className={`top-0 w-full ${isExpandable ? isScrolled ? "bg-rose fixed" : "bg-transparent absolute text-white" : "bg-rose cursor-pointer"} z-50 py-3 px-3 md:p-5 transition-all ease-in-out duration-500`}>
