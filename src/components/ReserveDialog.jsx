const ReserveDialog = ({ handleClose }) => {
    return (
        <div className="fixed z-50 top-0 w-screen h-screen bg-charcoal/50" onClick={handleClose}>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col bg-beige text-charcaol text-center gap-y-3 rounded-2xl px-20 py-10 border border-rose" onClick={(e) => e.stopPropagation()}>
